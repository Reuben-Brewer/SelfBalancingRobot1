...
if __name__ == '__main__':
    ...
    global RoboteqBLDCcontroller_MostRecentDict_ControlMode_IntegerValue
    RoboteqBLDCcontroller_MostRecentDict_ControlMode_IntegerValue = -11111.0
    ...
    if USE_RoboteqBLDCcontroller_FLAG == 1:
        try:
            RoboteqBLDCcontroller_ReubenPython2and3ClassObject = RoboteqBLDCcontroller_ReubenPython2and3Class(RoboteqBLDCcontroller_ReubenPython2and3ClassObject_setup_dict)
    ...
    while(EXIT_PROGRAM_FLAG == 0):
        ...
        if RoboteqBLDCcontroller_OPEN_FLAG == 1:
            ...
            if "Time" in RoboteqBLDCcontroller_MostRecentDict:
                ...
                RoboteqBLDCcontroller_MostRecentDict_ControlMode_IntegerValue = RoboteqBLDCcontroller_MostRecentDict["ControlMode_IntegerValue"]
                RoboteqBLDCcontroller_MostRecentDict_ControlMode_EnglishString = RoboteqBLDCcontroller_MostRecentDict["ControlMode_EnglishString"]
